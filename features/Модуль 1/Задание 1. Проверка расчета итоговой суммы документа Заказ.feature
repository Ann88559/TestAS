...
рассчитать сумму документа Заказ при изменении в строке товаров количества и цены

Контекст:
Дано Я открыл новый сеанс TestClient или подключил уже существующий

Сценарий: проверка расчета итоговой суммы документа заказа
// создание
...
* Проверка расчета суммы
	И элемент формы с именем "ТоварыИтогСумма" стал равен '74 250'
* Закрытие документа	
